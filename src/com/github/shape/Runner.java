...
public class Runner {
	...
	public static void main(String[] args) {
		...
		System.out.println("1) " + shapeTriangle + " -> perimeter=" + perimeter + "; square=" + square);
		/** create Square */
		...
		System.out.println("2) " + shapeSquare + " -> perimeter=" + perimeterSquare + "; area=" + areaSquare);
		/** create Circle */
		p1.setX(-2);
		p1.setY(-1);
		p2.setX(-1);
		...
		System.out.println("3) " + shapeCircle + " -> perimeter=" + perimeterCircle + "; area=" + squareCircle);
